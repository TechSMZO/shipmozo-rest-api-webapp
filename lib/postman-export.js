  ...
  return {
    info: {
      ...
      description:
        ...
        "1. Import a **Shipmozo Dev** or **Shipmozo Live** environment (or set `baseUrl` yourself).\n" +
    ...
    variable: [
      { key: "baseUrl", value: API_BACKENDS.dev.baseUrl },
...
function buildPostmanEnvironments() {
  return {
    dev: buildPostmanEnvironment("shipmozo-env-dev", "Shipmozo Dev", API_BACKENDS.dev.baseUrl),
    live: buildPostmanEnvironment("shipmozo-env-live", "Shipmozo Live", API_BACKENDS.live.baseUrl),
  };
}
